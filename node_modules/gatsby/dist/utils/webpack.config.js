          ...
          case 0:
                ...
                case `develop`:
                  ...
                  new _webpack2.default.NamedModulesPlugin(), new _friendlyErrorsWebpackPlugin2.default({
                    ...
                    compilationSuccessInfo: {
                      messages: [`Your site is running at http://localhost:${program.port}`, `Your graphql debugger is running at http://localhost:${program.port}/___graphql`]
                    }
                  })];
                case `develop-html`:
                ...
                case `build-javascript`:
                  {
                    ...
                    new _webpack2.default.NamedModulesPlugin(), new HashedChunkIdsPlugin()];
                  }
                default:
            ...
            entry = function entry() {
              switch (stage) {
                case `develop`:
                  return {
                    commons: [require.resolve(`react-hot-loader/patch`), `${require.resolve(`webpack-hot-middleware/client`)}?path=http://${program.host}:${webpackPort}/__webpack_hmr&reload=true`, directoryPath(`.cache/app`)]
                  };
                case `develop-html`:
                  return {
